          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Click icon to change • Select color below</p>
            ...
            {showIconPicker && (
              <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 animate-in slide-in-from-top-2">
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-3">Choose an icon</p>
